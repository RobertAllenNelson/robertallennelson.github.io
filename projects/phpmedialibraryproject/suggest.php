<?php
//Import the PHPmailer classinto the global namespace
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($error_message)) {
        ...
        $email_body .= "Title " . $details . "\n";
        $email_body .= "Format " . $details . "\n";
        $email_body .= "Genre " . $details . "\n";
        $email_body .= "Year " . $details . "\n";
        ...
        $mail->setFrom('bobnelson.bn@gmail.com', $name);
        $mail->addReplyTo($email, $name);
        $mail->addAddress('bobnelson.bn@gmail.com', 'Bob Nelson');
